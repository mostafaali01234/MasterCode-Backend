    ...
    public partial class MasterCode : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderHeaders_AspNetUsers_TechId",
                        column: x => x.TechId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedTime", "Description", "DisplayOrder", "Name" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 4, 7, 11, 15, 55, 64, DateTimeKind.Local).AddTicks(9250), "تطبيق سطح المكتب", 1, "DesktopApp" },
                    { 2, new DateTime(2025, 4, 7, 11, 15, 55, 64, DateTimeKind.Local).AddTicks(9254), "تطبيق ويب", 2, "WebApp" },
                    { 3, new DateTime(2025, 4, 7, 11, 15, 55, 64, DateTimeKind.Local).AddTicks(9258), "تطبيق موبايل", 3, "MobileApp" }
                });
